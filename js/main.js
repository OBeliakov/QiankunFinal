...
$(document)
  ...
  document.getElementById('list-city-1').onclick = function(){
    document.getElementById('feedback-form').style.display='none'
  };
  document.getElementById('list-city-2').onclick = function(){
    document.getElementById('feedback-form').style.display='none'
  };
  ...
  document.getElementById('close-appform').onclick = function(){
    document.getElementsByClassName('modal-backdrop').style.position='static'
  };
//   $('#list-city').on('shown.bs.modal', function () {
